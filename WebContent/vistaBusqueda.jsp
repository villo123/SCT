<%@page import="com.sct.incidencias.Busqueda.busqueda"%>
		...
		<div id="close"></div> 
		 <table border="2px" style="border-collapse: collapse;"> 
             ...
             <% 
             	...
             	ArrayList<String[]> registros = (ArrayList<String[]>)session.getAttribute("busqueda");
             	Iterator<String[]> it = registros.iterator();
